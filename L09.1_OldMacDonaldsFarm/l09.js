...
(function (Farm) {
    ...
    function loadAnimals() {
        let cow = new Animal("Milka", "cow", "greens", "moo", 10);
        let dog = new Animal("Bruno", "dog", "meat", "woof", 12);
        let cat = new Animal("Dexti", "cat", "fish", "miauz", 5);
        let chicken = new Animal("quicky chicky", "chicken", "corn", "bock", 30);
        let pig = new Animal("Piggy", "pig", "carrots", "quick", 25);
        animals.push(cow);
        animals.push(dog);
        animals.push(cat);
